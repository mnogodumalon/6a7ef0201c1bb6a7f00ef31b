  ...
  return (
    ...
    >
      ...
      <RecordSection title={t('details')} cols={2}>
        ...
        <RecordField label={fieldLabel('ausleihe', 'status')} value={record.fields.status} format="pill" />
        <RecordField label={fieldLabel('ausleihe', 'bemerkungen')} value={record.fields.bemerkungen} format="longtext" className="md:col-span-2" />
      </RecordSection>
