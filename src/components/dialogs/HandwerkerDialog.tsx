...
export type HandwerkerDialogDefaults = Omit<Handwerker['fields'], 'status'> & {
...
export function HandwerkerDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: HandwerkerDialogProps) {
  ...
  const REQUIRED_FIELDS = ['vorname', 'nachname', 'abteilung', 'status'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'abteilung': (
      <div key="abteilung" className="space-y-1.5">
        <Label htmlFor="abteilung">{fieldLabel('handwerker', 'abteilung')} <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="abteilung"
    ...
    'bemerkungen': (
      <div key="bemerkungen" className="space-y-1.5">
        ...
        <Textarea
          id="bemerkungen"
          placeholder="Besonderheiten, Fähigkeiten, Notizen..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "personalnummer": "Personalnummer", "telefon": "Telefon", "email": "E-Mail", "abteilung": "Abteilung", "status": "Status", "bemerkungen": "Bemerkungen"};
