// Auto-generated. Per-entity form-enhancements config for "Reparatur & Wartung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["werkzeug", "art", "beschreibung", {"row": ["startdatum", "enddatum"]}, "verantwortlicher_handwerker", "status", "kosten", "bemerkungen"],
  defaults: {
    'art': { kind: 'lookup', key: 'reparatur', label: 'Reparatur' },
    'status': { kind: 'lookup', key: 'offen', label: 'Offen' },
  },
  computed: {
    '_reparatur_dauer_tage': { kind: 'dateDiff', from: 'startdatum', to: 'enddatum', unit: 'days' },
  },
};
